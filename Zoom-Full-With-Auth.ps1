<#
    .SYNOPSIS
        Download Zoom, pacakge it as .Intunewin. 
    ...
    .DESCRIPTION
        ...
        The app packages will be downloaded from Zoom and Packaged automatically.
...
$sleep = 10
$SourceFile = "C:\Temp\Zoom\ZoomInstallerFull.intunewin"
...
$7Zip = Get-EvergreenApp -Name Zoom | Where-Object { $_.Type -eq "msi"}

$OutputFolder = "C:\Temp\Zoom"
...
# Download 1900 Zoom #
$URI = $7Zip.URI
$Outfile = "C:\Temp\Zoom" + "\ZoomInstallerFull.msi";
Invoke-WebRequest -Uri $URI -OutFile $OutFile -Verbose

$DownloadDestinationFolderPath = "C:\Temp\Zoom"

New-IntuneWin32AppPackage -SourceFolder $DownloadDestinationFolderPath -SetupFile "ZoomInstallerFull.msi" -OutputFolder $OutputFolder -Verbose
...
$Description = "Zoom $($DetectionXML.ApplicationInfo.MsiInfo.MsiProductVersion)"
