<#
    .SYNOPSIS
        Download 7-Zip 1900, pacakge it as .Intunewin. 
    ...
    .DESCRIPTION
        ...
        The app packages will be downloaded from 7-Zip and Packaged automatically.
...
$sleep = 10
$SourceFile = "C:\Temp\7-Zip\$MSIWin.intunewin"
...
$OutputFolder = "C:\Temp\7-zip"
if (-not(Test-Path -Path $OutputFolder)) {
    New-Item -Path $OutputFolder -ItemType Directory -Force | Out-Null
}

# Trim and Split to find the correct MSI from URI #
$7zuri = $7zip.URI
$7zMSI = $7zuri.trimStart("https://nchc.dl.sourceforge.net/project/sevenzip/7-Zip/")
$MSIFinal = $7zMSI.split('/')[-1]
$MSIWin = $MSIFinal.split('.')[0]

# Download 1900 7-Zip #
$URI = $7Zip.URI
$Outfile = "C:\Temp\7-zip" + "\$MSIFinal";
Invoke-WebRequest -Uri $URI -OutFile $OutFile -Verbose

$DownloadDestinationFolderPath = "C:\Temp\7-Zip"

New-IntuneWin32AppPackage -SourceFolder $DownloadDestinationFolderPath -SetupFile "$MSIFinal" -OutputFolder $OutputFolder -Verbose
...
$Description = "7-Zip $($DetectionXML.ApplicationInfo.MsiInfo.MsiProductVersion)"
