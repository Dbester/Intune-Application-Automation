<#
    .SYNOPSIS
        Download Latest version of Chrome, pacakge it as .Intunewin. 
    ...
    .DESCRIPTION
        ...
        The app packages will be downloaded from Chrome and Packaged automatically.
...
$sleep = 10
$SourceFile = "C:\Temp\Chrome\googlechromestandaloneenterprise64.intunewin"
...
$OutputFolder = "C:\Temp\Chrome"
if (-not(Test-Path -Path $OutputFolder)) {
    New-Item -Path $OutputFolder -ItemType Directory -Force | Out-Null
}

$outfile = "C:\Temp\Chrome\googlechromestandaloneenterprise64.msi"
Invoke-WebRequest "http://dl.google.com/edgedl/chrome/install/GoogleChromeStandaloneEnterprise64.msi" -OutFile $outfile

$DownloadDestinationFölderPath = "C:\Temp\Chrome"

New-IntuneWin32AppPackage -SourceFolder $DownloadDestinationFölderPath -SetupFile "googlechromestandaloneenterprise64.msi" -OutputFolder $OutputFolder -Verbose
...
$Description = "Chrome $($DetectionXML.ApplicationInfo.MsiInfo.MsiProductVersion)"
